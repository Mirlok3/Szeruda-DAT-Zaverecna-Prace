    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="justify-between">
            <div class="input-container">
                ...
                <input name="title" class="row-input-lg input" type="text" placeholder="Titulek"
                       value="<?= $data['posts'][0]->title ?>" autofocus required/>
            </div>
            <div class="input-container">
        ...
        <div class="input-container">
            ...
            <textarea name="description" rows="10" class="input textarea" required><?= $data['posts'][0]->description ?></textarea>
        </div>
